...
const Login = () => {
  ...
  const validateLogin = () => {
    const newErrors = {};
    if (!formData.emailOrUsername.trim() || formData.emailOrUsername.length < 1) {
      ...
      <div className="slide-in-left">
        <div className="login-container">
          <div className="login-form">
            ...
            />
            <input type="password" value={password} onChange={handlePasswordChange} placeholder="Mật khẩu" className="input-field" />
            <div className="options">
              <label>
                <input type="checkbox" checked={remember} onChange={handleCheckboxChange} /> Tự động đăng nhập
              </label>
