...
namespace MaternityCare_Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250130073455_SeedDataForUserAndPackage")]
    partial class SeedDataForUserAndPackage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 200, DateTimeKind.Local).AddTicks(3819),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 200, DateTimeKind.Local).AddTicks(3835),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 200, DateTimeKind.Local).AddTicks(3837),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 200, DateTimeKind.Local).AddTicks(3840),
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 201, DateTimeKind.Local).AddTicks(3398),
                            Duration = 10.0,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 201, DateTimeKind.Local).AddTicks(3403),
                            Duration = 10.0,
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CCCD = "123456789012",
                            CreatedAt = new DateTime(2025, 1, 30, 14, 34, 55, 202, DateTimeKind.Local).AddTicks(8122),
                            DateOfBirth = new DateOnly(2002, 1, 23),
                            Email = "admin@gmail.com",
                            FullName = "Admin",
                            IsActive = true,
                            IsEmailConfirmed = true,
                            Password = "AQAAAAIAAYagAAAAEPAjuqTao+RFEszMj9P98qq1fOmajCs/QGVV9vC7O6AUsHXW8dYWmifWt7f8uMwCYw==",
