...
namespace MaternityCare_Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250125064245_UpdateSubscriptionTable")]
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 889, DateTimeKind.Local).AddTicks(3506));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 889, DateTimeKind.Local).AddTicks(7647));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 890, DateTimeKind.Local).AddTicks(3664));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 890, DateTimeKind.Local).AddTicks(7566));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 890, DateTimeKind.Local).AddTicks(9937));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Fetus", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 891, DateTimeKind.Local).AddTicks(2256));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Like", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 891, DateTimeKind.Local).AddTicks(6894));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Package", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 892, DateTimeKind.Local).AddTicks(453));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 893, DateTimeKind.Local).AddTicks(2579));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 25, 13, 42, 44, 893, DateTimeKind.Local).AddTicks(6107));
