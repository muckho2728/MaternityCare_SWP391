...
namespace MaternityCare_Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250121065727_AddTokenToUserTable")]
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 44, DateTimeKind.Local).AddTicks(9472));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 45, DateTimeKind.Local).AddTicks(2665));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 45, DateTimeKind.Local).AddTicks(7611));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 46, DateTimeKind.Local).AddTicks(551));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 46, DateTimeKind.Local).AddTicks(2422));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Fetus", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 46, DateTimeKind.Local).AddTicks(4288));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Like", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 46, DateTimeKind.Local).AddTicks(7891));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Package", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 47, DateTimeKind.Local).AddTicks(712));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 48, DateTimeKind.Local).AddTicks(212));
            ...
            modelBuilder.Entity("MaternityCare_Backend.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 1, 21, 13, 57, 27, 48, DateTimeKind.Local).AddTicks(2982));
